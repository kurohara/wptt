...
function setup() {
	 ...
	 */
	load_theme_textdomain( ns_("") , get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu',      ns_("")  ),
		'social'  => __( 'Social Links Menu', ns_("")  ),
	) );
...
function widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Widget Area', ns_("") ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here to appear in your sidebar.', ns_("")  ),
...
function fonts_url() {
	 ...
	 */
	if ( 'off' !== _x( 'on', 'Noto Sans font: on or off', ns_("") ) ) {
	 ...
	 */
	if ( 'off' !== _x( 'on', 'Noto Serif font: on or off', ns_("") ) ) {
	 ...
	 */
	if ( 'off' !== _x( 'on', 'Inconsolata font: on or off', ns_("") ) ) {
	 ...
	 */
	$subset = _x( 'no-subset', 'Add new subset (greek, cyrillic, devanagari, vietnamese)', ns_("") );
...
function scripts() {
	...
	wp_localize_script( ns_('-script'), 'screenReaderText', array(
		'expand'   => '<span class="screen-reader-text">' . __( 'expand child menu', ns_('') ) . '</span>',
		'collapse' => '<span class="screen-reader-text">' . __( 'collapse child menu', ns_('') ) . '</span>',
	) );
